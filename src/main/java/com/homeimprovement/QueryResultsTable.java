...
/**
 * *******************************************************************************
 * QueryResultsTable displays the results of the user defined query parameter.
 * The class allows the user to remove incorrect data from cost.csv file
 *
            ...
            for (int j = 0; j < COLS; j++) {
                ...
                switch (j) {
                    ...
                    case 0:
                        ...
                        break;
                    case 1:
                        data[i][j] = myList.get(i).getArea();
                        break;
                    case 2:
                        data[i][j] = myList.get(i).getItem();
                        break;
                    case 3:
                        data[i][j] = myList.get(i).getCost();
                        break;
                    case 4:
                        data[i][j] = myList.get(i).getReceiptFilename();
                        break;
                    case 5:
                        data[i][j] = myList.get(i).getInfo();
                        break;
                    case 6:
                        data[i][j] = myList.get(i).getIsValue();
                        break;
                    default:
                }//end switch
            }
